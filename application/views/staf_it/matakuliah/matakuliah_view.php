...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
    Matakuliah
    <small>Matakuliah Universitas Pertamina</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>staf_it/home"><i class="fa fa-home"></i> Beranda</a></li>
      <li class="active"><i class="fa fa-users"></i> Matakuliah</li>
    </ol>
  </section>
  <!-- Main content -->
        ...
        <div class="box box-info">
          <div class="box-header ">
            <div class="col-xs-8">
              ...
              <a href="<?php echo base_url(); ?>staf_it/matakuliah/add"class="btn btn-sm btn-success"><div class="fa fa-user-plus"></div> Tambah matakuliah</a>&nbsp;
              <!-- Split button -->
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <td>
                  ...
                  <center>
                  <a href="#" data-toggle="modal" data-target="#hapus" data-id="<?php echo $row->id_matakuliah ?>" data-jenis="matakuliah" class="btn btn-sm btn-danger btn-circle" data-lilili="tooltip" data-original-title="Hapus Data"><div class="fa fa-trash"></div></a>
                  </center>
                </td>
              </tr>
              <?php endforeach; ?>
